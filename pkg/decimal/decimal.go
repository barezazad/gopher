...
// MulToFloat getting float as parameter
func (d Decimal) MulToFloat(num float64) Decimal {
	d2 := NewFromFloat(num)
	return d.Mul(d2)
}
...
// DivToFloat getting float as parameter
func (d Decimal) DivToFloat(num float64) Decimal {
	d2 := NewFromFloat(num)
	return d.Div(d2)
}
...
// MustFloat64 use Float64 but return the float
func (d Decimal) MustFloat64() (f float64) {
	f, _ = d.Rat().Float64()
	return
}
...
// Build return the pointer to Decimal
func (d Decimal) Build() *Decimal {
	return &d
}

// Num return the deciamal type, in case it is nil return 0
func (d *Decimal) Num() Decimal {
	if d == nil {
